...
If its your first time using Project Athena, you'll start your journey a local space by yourself, where you can experiment with the controls and learn about the product. When you are ready, try exploring other domains using the GoTo and socialize with people around the metaverse. If you've visited Project Athena before, you will return to the location where you last visited. 
...
.. toctree::
    ...
    Get Started with Project Athena <explore/get-started>
