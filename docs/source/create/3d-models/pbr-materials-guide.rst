...
Athena supports the use of the following texture formats: 
...
All materials in Athena have the following channels that determine how they look:
...
2. Athena’s renderer can draw two different kinds of transparency: "alpha" (255 graduates steps of transparency, no shading on surface, casts no shadows,) and "mask" (binary transparency, full shading of opaque surface, whole surface casts shadow.)
...
When you create a model in Blender, you have to export it in the FBX format to use in Athena. Additionally, you have to modify material properties and textures in Blender to match the PBR material textures in Athena. 
