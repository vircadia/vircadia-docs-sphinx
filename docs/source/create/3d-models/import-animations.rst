...
4. Disable any kind of keyframe reductions. In Blender, set the "simplify" setting to 0.00 when exporting an FBX file since this will cause the animation to not play properly.
