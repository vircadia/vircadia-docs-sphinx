...
Portals in Project Athena transport you to the domain of your choice. You can use these portals to travel to a domain you visit frequently instead of using the **GoTo** app on your HUD or Tablet. 
...
6. Add `hifi:// welcome` (Project Athena's welcome domain) to the 'User Data' field. (TODO: is hifi://welcome reachable and should this be the welcome domain or palace?)
...
You will be teleported to Project Athena's welcome domain. 
