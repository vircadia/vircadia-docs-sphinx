...
+ Uses Project Athena's [JavaScript API](https://apidocs.highfidelity.com) to determine when a user walks into the entity and the teleport destination.
...
6. Add `hifi:// welcome` (Project Athena's welcome domain) to the 'User Data' field. 
