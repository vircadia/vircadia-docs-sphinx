...
* Lock any entities you don't want cloned, then :doc:`restrict user 'Lock' permissions <../../host/configure-settings/permission-settings>` to the users of your choice.
