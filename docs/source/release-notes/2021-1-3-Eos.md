...
This version of Vircadia is an update to 2021.1.2. It is compatible with the 2020.1.0 Eos protocol. This version was released on September 21st, 2021.
...
-  Replace deprecated QAbstractsocket::error with QAbstractSocket::error… [#1303](https://github.com/vircadia/vircadia/pull/1303)
-  Fix nvtt on x86 platforms. [#1255](https://github.com/vircadia/vircadia/pull/1255)
-  Fix QString::SplitBehavior deprecation, replace with Qt:: [#1302](https://github.com/vircadia/vircadia/pull/1302)
