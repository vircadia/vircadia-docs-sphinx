...
The numbers at the end of each item are the PR numbers in the Project Athena [GitHub repo](https://github.com/kasenvr/project-athena/projects/2).
...
The numbers at the end of each item are the PR numbers in the Vircadia-Docs-Sphinx [GitHub repo](https://github.com/kasenvr/vircadia-docs-sphinx). 
...
The API docs are generated by from the software source [GitHub repo](https://github.com/kasenvr/project-athena/projects/2).
Additionally, the latest deployment source can be viewed [here](https://github.com/kasenvr/vircadia-api-docs).
...
The numbers at the end of each item are the PR numbers in the Decentralized GoTo [GitHub repo](https://github.com/kasenvr/Decentralized_GoTo_Experimental).
