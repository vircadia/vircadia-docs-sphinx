...
* Fixed crashes in the following scenarios: 
    ...
    * Using the using the `ScriptDiscoveryService.scriptsModel` property and trying to access data for a non-existent row in the model
